    ...
    return (
        <div className="about-container">
            <div className="container">
                ...
                <p>
                    At Vintage Volumes, we believe in the magic that each book
                    holds—the stories that transport you to different eras, the characters
                    that become lifelong companions, and the wisdom that transcends time.
                    Our curated collection reflects our dedication to preserving the
                    charm of classic literature and making it accessible to enthusiasts
                    around the globe.
                </p>
